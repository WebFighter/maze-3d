...
此模板提供了一个最小化的配置，使 React 能够在 Vite 中运行，支持 HMR（热模块替换）以及一些 ESLint 规则。
...
此模板已启用 React 编译器。有关更多信息，请参阅[此文档](https://react.dev/learn/react-compiler)。

注意：这会影响 Vite 的开发和构建性能。
